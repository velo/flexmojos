...
public class LocalSdkEntry implements Comparable<LocalSdkEntry>
{
	...
	public LocalSdkEntry( String groupId, String artifactId, String path, String sourcePath, ProjectType projectType, ProjectLinkTypeMap projectLinkTypeMap )
	{
	...
	/**
	 * Evaluates any modifications done by the Maven dependency that don't
	 * match up to the local SDK entry and returns an object containing the changes.
	 * 
	 * @param dependency
	 * @return
	 */
