...
public class SourceFileResolverTest
{
    ...
    {
        File file =
            SourceFileResolver.resolveSourceFile( null, getDir( "packagegroup" ), "net.flexmojos.oss", null );
        Assert.assertTrue( file.exists() );
    ...
    {
        File file =
            SourceFileResolver.resolveSourceFile( null, getDir( "packageartifact" ), "net.flexmojos.oss",
                                                  "artifactid" );
        Assert.assertTrue( file.exists() );
    ...
    {
        SourceFileResolver.resolveSourceFile( null, getDir( "notresolvepackage" ), "net.flexmojos.oss",
                                              "artifactid" );
    }
    ...
    public void notResolvePackageArtifactid()
    {
        SourceFileResolver.resolveSourceFile( null, getDir( "notresolvepackageid" ),
                                              "net.flexmojos.oss.artifactid", "artifactid" );
    }
