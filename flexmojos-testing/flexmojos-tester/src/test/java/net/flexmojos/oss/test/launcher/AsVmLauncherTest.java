    ...
    extends AbstractAsVmLauncherTest
{
        ...
        throws Exception
    {
        ...
        assertEquals( launcher.getStatus(), ThreadStatus.DONE, 
			((launcher.getError() != null) ? " got error: " + launcher.getError().getMessage() : "") + 
			" tmp: " + Arrays.toString( new File( "/tmp" ).listFiles() ) );
