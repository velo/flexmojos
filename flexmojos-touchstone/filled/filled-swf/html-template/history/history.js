...
BrowserHistory = (function() {
			...
			if (typeof r.SetVariable != "undefined") {
				...
				if (o.length > 0 && typeof o[0].SetVariable != "undefined") {
					return o[0];
						...
						&& typeof e[0].SetVariable != "undefined") {
					return e[0];
				}
			}
		} else {
	...
	/*
	 * Add a history entry to the browser. baseUrl: the portion of the location
	 * prior to the '#' newUrl: the entire new URL, including '#' and following
	 * fragment flexAppUrl: the portion of the location following the '#' only
	 */
	function addHistoryEntry(baseUrl, newUrl, flexAppUrl) {
		...
		if (browser.ie) {
			...
			if (browser.safari) {
				// for Safari, submit a form whose action points to the desired
				// URL
				...
				// Otherwise, write an anchor into the page and tell the browser
				// to go there
	...
	/*
	 * Write an anchor into the page to legitimize it as a URL for Firefox et
	 * al.
	 */
	function addAnchor(flexAppUrl) {
		if (document.getElementsByName(flexAppUrl).length == 0) {
			getAnchorElement().innerHTML += "<a name='" + flexAppUrl + "'>"
					+ flexAppUrl + "</a>";
		}
	}
	...
	return {
		 ...
		 * propagate the application state out to the container.
		 */
